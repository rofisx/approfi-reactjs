...
import { Card, Col, Container, Image, ListGroup, Nav, Navbar, Row} from "react-bootstrap";
        ...
        return(
            <div className={`${style.backpage}`}>
                ...
                <Navbar collapseOnSelect fixed='top' expand="lg" bg='dark' variant='dark'>
                    <Container fluid>
                    <Navbar.Brand href="/">Resume of Rofi</Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarScroll" />
                        <Navbar.Collapse id="navbarScroll">
                            ...
                            <Nav.Link href="#hobi">Hobi</Nav.Link>
                            </Nav>
                        </Navbar.Collapse>
                    </Container>
                </Navbar>
